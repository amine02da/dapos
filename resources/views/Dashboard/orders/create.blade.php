                            ...
                            <div class="card-body">
                                ...
                                <div id="accordion-two" class="accordion">
                                        <div class="card">
                                            ...
                                            <div id="{{str_replace(" ", "-", $categroy->name)}}" class="collapse" data-parent="#accordion-two">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        @foreach($categroy->products as $product)
                                                            <tr>
                                                                ...
                                                                <td> <a 
                                                                    href="#" class="btn text-white btn-success p-2 add-product-btn"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="accordion-one" class="accordion">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5 class="mb-0" data-toggle="collapse" data-target="#prod-{{str_replace(" ", "-", $order->id)}}" aria-expanded="true" aria-controls="{{str_replace(" ", "-", $order->id)}}"><i class="fa" aria-hidden="true"></i>{{ $order->created_at }}</h5>
                                            </div>
                                            <div id="prod-{{str_replace(" ", "-", $order->id)}}" class="collapse" data-parent="#accordion-one">
                                                <div class="card-body table-responsive">
                                                    <table class="table">
                                                        <tr>
                                                            <td>Product</td>
        ...
        $(document).ready(function() {
            ...
            $(".add-product-btn").on("click", function(e){
                ...
                var html = 
                    `
                        <tr>
                            <td><img class="mr-3 rounded-circle" height="50px" width="50px" src="/storage/${image}" alt="${image}"></td>
